...
void cTransmission::InitGearRatios()
{
    ...
    {
        static auto& gear = StaticRef<tTransmissionGear*>(0xC1CB34); // TODO | STATICREF // = nullptr;
        static auto& previousGear = StaticRef<tTransmissionGear*>(0xC1CB30); // TODO | STATICREF // = nullptr;
        gear = &m_aGears[i];
...
{
    static auto& cheatMultiplier = StaticRef<float>(0xC1CB3C);      // TODO | STATICREF // = 0.0f;
    static auto& driveAcceleration = StaticRef<float>(0xC1CB38);    // TODO | STATICREF // = 0.0f;
    static auto& currentVelocity = StaticRef<float>(0xC1CB40);      // TODO | STATICREF // = 0.0f;
