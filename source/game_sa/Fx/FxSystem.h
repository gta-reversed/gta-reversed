...
public:
    ...
    void AddParticle(RwMatrix* mat, const CVector* vel, float timeSince, const FxPrtMult_c* fxMults, float rotZ, float lightMult, float lightMultLimit, bool createLocal);
