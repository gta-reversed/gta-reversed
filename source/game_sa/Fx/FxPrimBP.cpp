...
bool FxPrimBP_c::Load(FILESTREAM file, int32 version, FxName32_t* textureNames) {
    ...
    VERIFY(sscanf(line, "%s %f %f %f %f %f %f %f %f %f %f %f %f", field, &mat[0].x, &mat[0].y, &mat[0].z, // right
                  &mat[1].x,
                  &mat[1].y,
                  &mat[1].z, // up
                  &mat[2].x,
    ...
    if (mat[0] == CVector{ 1.0f, 0.0f, 0.0f } && mat[1] == CVector{ 0.0f, 1.0f, 0.0f } && mat[2] == CVector{ 0.0f, 0.0f, 1.0f } && mat[3] == CVector{ 0.0f, 0.0f, 0.0f }) {
