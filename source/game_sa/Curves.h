...
public:
    ...
    static void CalcCurvePoint(const CVector& startCoors, const CVector& endCoors, const CVector& startDir, const CVector& endDir, float time, int32 traverselTimeInMS, CVector& resultCoor, CVector& resultSpeed);
