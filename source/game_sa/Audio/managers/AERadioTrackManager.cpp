...
void CAERadioTrackManager::Load() {
    ...
    for (auto r = 0; r < RADIO_COUNT; r++) {
        ...
        for (auto i = 0; i < IDENT_INDEX_HISTORY_COUNT; i++) {
            CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nIdentIndexHistory[r].indices[i], sizeof(m_nIdentIndexHistory[r].indices[i]));
        }

        for (auto i = 0; i < ADVERT_INDEX_HISTORY_COUNT; i++) {
            CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nAdvertIndexHistory[r].indices[i], sizeof(m_nAdvertIndexHistory[r].indices[i]));
        }

        for (auto i = 0; i < DJBANTER_INDEX_HISTORY_COUNT; i++) {
            CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nDJBanterIndexHistory[r].indices[i], sizeof(m_nDJBanterIndexHistory[r].indices[i]));
        }
    }

    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsCitiesPassed,          sizeof(m_nStatsCitiesPassed));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedCasino3,         sizeof(m_nStatsPassedCasino3));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedCasino6,         sizeof(m_nStatsPassedCasino6));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedCasino10,        sizeof(m_nStatsPassedCasino10));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedCat1,            sizeof(m_nStatsPassedCat1));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedDesert1,         sizeof(m_nStatsPassedDesert1));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedDesert3,         sizeof(m_nStatsPassedDesert3));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedDesert5,         sizeof(m_nStatsPassedDesert5));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedDesert8,         sizeof(m_nStatsPassedDesert8));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedDesert10,        sizeof(m_nStatsPassedDesert10));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedFarlie3,         sizeof(m_nStatsPassedFarlie3));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedLAFin2,          sizeof(m_nStatsPassedLAFin2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedMansion2,        sizeof(m_nStatsPassedMansion2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedRyder2,          sizeof(m_nStatsPassedRyder2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedRiot1,           sizeof(m_nStatsPassedRiot1));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedSCrash1,         sizeof(m_nStatsPassedSCrash1));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedStrap4,          sizeof(m_nStatsPassedStrap4));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedSweet2,          sizeof(m_nStatsPassedSweet2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedTruth2,          sizeof(m_nStatsPassedTruth2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsPassedVCrash2,         sizeof(m_nStatsPassedVCrash2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsStartedBadlands,       sizeof(m_nStatsStartedBadlands));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsStartedCat2,           sizeof(m_nStatsStartedCat2));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsStartedCrash1,         sizeof(m_nStatsStartedCrash1));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsLastHitGameClockDays,  sizeof(m_nStatsLastHitGameClockDays));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsLastHitGameClockHours, sizeof(m_nStatsLastHitGameClockHours));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nStatsLastHitTimeOutHours,   sizeof(m_nStatsLastHitTimeOutHours));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nSpecialDJBanterPending,     sizeof(m_nSpecialDJBanterPending));
    CGenericGameStorage::LoadDataFromWorkBuffer_Org(&m_nSpecialDJBanterIndex,       sizeof(m_nSpecialDJBanterIndex));
}
