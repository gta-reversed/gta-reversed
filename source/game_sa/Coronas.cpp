...
auto& aCoronastar = StaticRef<std::array<char[26], eCoronaType::CORONATYPE_COUNT - 1>, 0x8D4950>();
auto& coronaTexturesAlphaMasks = StaticRef<std::array<char[26], eCoronaType::CORONATYPE_COUNT - 1>, 0x8D4A58>();
