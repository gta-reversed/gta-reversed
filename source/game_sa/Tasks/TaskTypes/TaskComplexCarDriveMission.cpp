...
void CTaskComplexCarDriveMission::SetUpCar() {
    ...
    autopilot.m_CruiseSpeed        = (uint32)m_CruiseSpeed;
    autopilot.m_ActualSpeed               = (float)autopilot.m_CruiseSpeed;
    autopilot.m_DrivingMode    = (eCarDrivingStyle)m_CarDrivingStyle;
