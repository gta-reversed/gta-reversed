...
class CGlass {
public:
    static inline auto (&PanePolyPositions)[4][3] = StaticRef<CVector2D[4][3]>(0x8D5CD8);
    ...
    static inline auto (&ReflectionPolyVertexBuffer)[1706] = StaticRef<RxObjSpace3DLitVertex[1706]>(0xC5B158);
    static inline auto (&ShatteredPolyVertexBuffer)[512] = StaticRef<RxObjSpace3DLitVertex[512]>(0xC56958);
    ...
    static inline auto (&PanePolyCenterPositions)[5] = StaticRef<CVector2D[5]>(0xC71B30);
    static inline auto (&apEntitiesToBeRendered)[32] = StaticRef<CEntity*[32]>(0xC71B58);
    static inline auto& NumGlassEntities = StaticRef<uint32>(0xC71BD8);
    static inline auto (&aGlassPanes)[44] = StaticRef<CFallingGlassPane[44]>(0xC71BF8);
