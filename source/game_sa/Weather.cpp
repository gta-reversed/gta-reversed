...
auto& CWeather::TrafficLightsBrightness = StaticRef<float>(0xC812A8);
auto& CWeather::bScriptsForceRain = StaticRef<bool>(0xC812AC);
auto& CWeather::Earthquake = StaticRef<float>(0xC81340);
auto& CWeather::CurrentRainParticleStrength = StaticRef<uint32>(0xC812B0);
auto& CWeather::LightningStartY = StaticRef<uint32>(0xC812B4);
auto& CWeather::LightningStartX = StaticRef<uint32>(0xC812B8);
auto& CWeather::LightningFlashLastChange = StaticRef<int32>(0xC812BC);
auto& CWeather::WhenToPlayLightningSound = StaticRef<int32>(0xC812C0);
auto& CWeather::LightningDuration = StaticRef<uint32>(0xC812C4);
auto& CWeather::LightningStart = StaticRef<uint32>(0xC812C8);
auto& CWeather::LightningFlash = StaticRef<bool>(0xC812CC);
auto& CWeather::LightningBurst = StaticRef<bool>(0xC812CD);
auto& CWeather::HeadLightsSpectrum = StaticRef<float>(0xC812D0);
auto& CWeather::WaterFogFXControl = StaticRef<float>(0xC81338);
auto& CWeather::HeatHazeFXControl = StaticRef<float>(0xC812D8);
auto& CWeather::HeatHaze = StaticRef<float>(0xC812DC);
auto& CWeather::SunGlare = StaticRef<float>(0xC812E0);
auto& CWeather::Rainbow = StaticRef<float>(0xC812E4);
auto& CWeather::Wavyness = StaticRef<float>(0xC812E8);
auto& CWeather::WindClipped = StaticRef<float>(0xC812EC);
auto& CWeather::WindDir = StaticRef<CVector>(0xC813E0);
auto& CWeather::Wind = StaticRef<float>(0xC812F0);
auto& CWeather::Sandstorm = StaticRef<float>(0xC812F4);
auto& CWeather::Rain = StaticRef<float>(0xC81324);
auto& CWeather::InTunnelness = StaticRef<float>(0xC81334);
auto& CWeather::WaterDepth = StaticRef<float>(0xC81330);
auto& CWeather::UnderWaterness = StaticRef<float>(0xC8132C);
auto& CWeather::ExtraSunnyness = StaticRef<float>(0xC812F8);
auto& CWeather::Foggyness_SF = StaticRef<float>(0xC812FC);
auto& CWeather::Foggyness = StaticRef<float>(0xC81300);
auto& CWeather::CloudCoverage = StaticRef<float>(0xC81304);
auto& CWeather::WetRoads = StaticRef<float>(0xC81308);
auto& CWeather::InterpolationValue = StaticRef<float>(0xC8130C);
auto& CWeather::WeatherTypeInList = StaticRef<uint32>(0xC81310);
auto& CWeather::WeatherRegion = StaticRef<eWeatherRegion>(0xC81314);
auto& CWeather::ForcedWeatherType = StaticRef<eWeatherType>(0xC81318);
auto& CWeather::NewWeatherType = StaticRef<eWeatherType>(0xC8131C);
auto& CWeather::OldWeatherType = StaticRef<eWeatherType>(0xC81320);
auto& CWeather::m_WeatherAudioEntity = StaticRef<CAEWeatherAudioEntity>(0xC81360);
auto& CWeather::StreamAfterRainTimer = StaticRef<bool>(0x8D5EAC);
