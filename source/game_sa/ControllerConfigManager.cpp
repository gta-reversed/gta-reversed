...
void CControllerConfigManager::ClearVehicleMappings(eControllerAction nop, KeyCode button, eControllerType type) {
    ...
    CheckAndClear(eControllerAction::VEHICLE_STEERLEFT, type, button);
    CheckAndClear(eControllerAction::VEHICLE_STEERRIGHT, type, button);
    CheckAndClear(eControllerAction::VEHICLE_STEERUP, type, button);
    CheckAndClear(eControllerAction::VEHICLE_STEERDOWN, type, button);
...
const GxtChar* CControllerConfigManager::GetControllerSettingText(eControllerAction action, eContSetOrder order) {
    for (const auto& type : CONTROLLER_TYPES_ALL) {
        if (m_Actions[+action].Keys[+type].m_uiSetOrder == order) {
            ...
            case eControllerType::OPTIONAL_EXTRA_KEY: return GetKeyNameForKeyboard(action, type);
...
bool CControllerConfigManager::GetIsActionAButtonCombo(eControllerAction Action) {
    ...
    switch (Action) {
    case eControllerAction::VEHICLE_LOOK_BEHIND:
...
void CControllerConfigManager::AffectControllerStateOn_ButtonDown_Driving(KeyCode button, eControllerType type, CControllerState* state) {
    ...
    CheckAndSetStick(eControllerAction::VEHICLE_STEERUP, type, button, state->LeftStickY, m_bStickL_Up_Dwn_MovementBothDown[+type], -128);
    CheckAndSetStick(eControllerAction::VEHICLE_STEERDOWN, type, button, state->LeftStickY, m_bStickL_Up_Dwn_MovementBothDown[+type], 128);
    CheckAndSetStick(eControllerAction::VEHICLE_STEERLEFT, type, button, state->LeftStickX, m_bStickL_X_Rgh_Lft_MovementBothDown[+type], -128);
    CheckAndSetStick(eControllerAction::VEHICLE_STEERRIGHT, type, button, state->LeftStickX, m_bStickL_X_Rgh_Lft_MovementBothDown[+type], 128);
...
void CControllerConfigManager::InitDefaultControlConfiguration() {
    ...
    SetControllerKeyAssociatedWithAction(eControllerAction::PED_FIRE_WEAPON_ALT, RsKeyCodes(notsa::IsFixBugs() ? '0' : '\\'), eControllerType::KEYBOARD);
    ...
    // Fixes key mapping issue between old Windows 98 and modern systems
    SetControllerKeyAssociatedWithAction(eControllerAction::PED_CENTER_CAMERA_BEHIND_PLAYER, RsKeyCodes(notsa::IsFixBugs() ? '3' : '#'), eControllerType::KEYBOARD);
    SetControllerKeyAssociatedWithAction(eControllerAction::PED_LOOKBEHIND, rsPADEND, eControllerType::KEYBOARD);
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERUP, rsUP, eControllerType::KEYBOARD);
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERDOWN, rsDOWN, eControllerType::KEYBOARD);
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_RADIO_STATION_UP, rsINS, eControllerType::KEYBOARD);

    if (FrontEndMenuManager.m_nTextLanguage == 1) {
        SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERLEFT, (RsKeyCodes)'Q', eControllerType::KEYBOARD);
        ...
        SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERLEFT, (RsKeyCodes)'A', eControllerType::KEYBOARD);
    ...
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERRIGHT, (RsKeyCodes)'D', eControllerType::KEYBOARD);
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERLEFT, rsLEFT, eControllerType::OPTIONAL_EXTRA_KEY);
    SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_STEERRIGHT, rsRIGHT, eControllerType::OPTIONAL_EXTRA_KEY);
    ...
    if (notsa::IsFixBugs()) {
        SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_LOOKBEHIND, rsPAD5, eControllerType::KEYBOARD);
        SetControllerKeyAssociatedWithAction(eControllerAction::VEHICLE_MOUSELOOK, '*', eControllerType::KEYBOARD);
    }
...
void CControllerConfigManager::InitialiseControllerActionNameArray() {
    ...
    GxtCharStrcpy(m_ControllerActionName[+eControllerAction::VEHICLE_STEERLEFT], "VEHICLE_STEERLEFT"_gxt);
    GxtCharStrcpy(m_ControllerActionName[+eControllerAction::VEHICLE_STEERRIGHT], "VEHICLE_STEERRIGHT"_gxt);
    GxtCharStrcpy(m_ControllerActionName[+eControllerAction::VEHICLE_STEERUP], "VEHICLE_STEERUP"_gxt);
    GxtCharStrcpy(m_ControllerActionName[+eControllerAction::VEHICLE_STEERDOWN], "VEHICLE_STEERDOWN"_gxt);
...
eActionType CControllerConfigManager::GetActionType(eControllerAction action) {
    ...
    case eControllerAction::VEHICLE_STEERLEFT:
    case eControllerAction::VEHICLE_STEERRIGHT:
    case eControllerAction::VEHICLE_STEERUP:
    case eControllerAction::VEHICLE_STEERDOWN:
