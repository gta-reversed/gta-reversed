...
public:
    ...
    static inline auto (&ms_waterCreatureInfos)[NUM_WATER_CREATURE_INFOS] = StaticRef<WaterCreatureInfo[NUM_WATER_CREATURE_INFOS]>(0x8D3698); // Access using GetCreatureInfo()
