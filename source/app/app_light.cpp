...
void SetAmbientColoursToIndicateRoadGroup(int32 idx) {
    static auto (&IndicateR)[8] = StaticRef<uint8[8]>(0x8D60D0);
    static auto (&IndicateG)[8] = StaticRef<uint8[8]>(0x8D60D8);
    static auto (&IndicateB)[8] = StaticRef<uint8[8]>(0x8D60E0);
