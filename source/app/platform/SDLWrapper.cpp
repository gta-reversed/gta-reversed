...
bool ProcessKeyboardEvent(SDL_Event& e, CKeyboardState& ks) {
    ...
    case SDL_EVENT_KEY_UP: {
        ...
        case SDLK_UP:           ks.up = s;                      break;
        case SDLK_DOWN:         ks.down = s;                    break;
        case SDLK_LEFT:         ks.left = s;                    break;
        case SDLK_RIGHT:        ks.right = s;                   break;
        ...
        case SDLK_KP_ENTER:     ks.extenter = ks.enter = s;     break; // (?)
        case SDLK_PERIOD:       ks.decimal = s;                 break;
        case SDLK_CAPSLOCK:     ks.capslock = s;                break;
        case SDLK_LSHIFT:       ks.shift |= (ks.lshift = s);    break;
        case SDLK_RSHIFT:       ks.shift |= (ks.rshift = s);    break;
