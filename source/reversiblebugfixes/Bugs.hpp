...
inline const ReversibleBugFix CPedToPlayerConversations_Update_DontWithGangWarn{
    .Name        = "CPedToPlayerConversations::Update Dont with Gang Warn",
    .Description = "You cannot talk during Gang Warn.",
    .Credit      = "WDS"
};
};
